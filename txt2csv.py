...
# 定义文件夹路径
input_folder_path = 'D:\\CLAS-PBM闭环调控数据\\睡眠分期标签txt'
output_folder_path = 'D:\\研究生\\HR_trend_pro1\\result_csv'
...
for n in range(1, 40):
    # 格式化文件名为两位数
    input_file_name = f'Down_SLP0{n:02d}.txt'  # 使用 {n:02d} 格式
    input_file_path = os.path.join(input_folder_path, input_file_name)
    output_file_name = f'Down_SLP0{n:02d}.csv'
