...
# 加载数据
excel_rmssd_path = "D:\\研究生\\project\整晚心率分析\\result\\R_SDNN_RMSSD\\RMSSD.xlsx"
...
excel_sdnn_path = "D:\\研究生\\project\\整晚心率分析\\result\\R_SDNN_RMSSD\\副本SDNN.xlsx"
num_list_s, base_list_s, up_list_s, down_list_s = extract_hr_lists_from_excel(
    excel_sdnn_path,
    sheet_name
)

r_number__path = "D:\\研究生\\project\\整晚心率分析\\result\\R_SDNN_RMSSD\\R_number.xlsx"
num_list_R, base_list_R, up_list_R, down_list_R = extract_hr_lists_from_excel(
    r_number__path,
    sheet_name
)
...
remove_list = []
remove_list = [6, 11, 12, 19, 23, 26, 28, 37, 8, 20, 38]
#remove_list = [6, 8, 11, 12, 28, 37, 29, 38]
#remove_list = [6, 29, 36, 30, 37, 19, 21]
...
t_stat, p_value = stats.wilcoxon(base_list_r, up_list_r)
print(p_value)
